...
mask1_path = base_path + "brush_hair/April_09_brush_hair_u_nm_np1_ba_goo_1.npz"
mask2_path = base_path + "brush_hair/April_09_brush_hair_u_nm_np1_ba_goo_2.npz"
# mask2_path = (
#     base_path
...
print("IoU CuPy packed:", iou_cupy_packed)
